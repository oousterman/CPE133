...
## Switches
set_property PACKAGE_PIN V17 [get_ports {EVEN_in}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {EVEN_in}]
set_property PACKAGE_PIN V16 [get_ports {ODD_in}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ODD_in}]
...
set_property PACKAGE_PIN R2 [get_ports {UP_in}]					
...
set_property PACKAGE_PIN T17 [get_ports HOLD_in]						
